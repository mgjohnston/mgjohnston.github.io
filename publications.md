...
{% for pub in site.categories.publication %}
  <li>
    ...
    <p> <a href="{{ site.baseurl }}{{ post.url }}">Abstract</a> {% if pub.preprint-doi != "NA" and pub.work-type != "preprint" %} Originally a <a href="https://doi.org/{{ pub.preprint-doi}}">preprint</a>.{% endif %}</p>
  </li>
{% endfor %}
</ol>
